 ...
 * @author rubco
 */
public class ActualizarSocioDialog extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ActualizarSocioDialog.class.getName());
  
    /**
     * Creates new form InsertarMonitorDialog
     */
    public ActualizarSocioDialog(java.awt.Frame parent, boolean modal, Socio socio) throws ParseException {
        super(parent, modal);
        initComponents();
        
        codigoTextField.setText(socio.getNumeroSocio());
        codigoTextField.setEnabled(false);
        
        nombreTextField.setText(socio.getNombre());
        dniTextField.setText(socio.getDni());
        
        telefonoTextField.setText(socio.getTelefono());
        correoTextField.setText(socio.getCorreo());
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Date date = sdf.parse(socio.getFechaNacimiento());
        fNac.setDate(date);
        date = sdf.parse(socio.getFechaEntrada());
        fAlt.setDate(date);
        int indice = 0;
        ...
        categoria.setSelectedIndex(indice);
    ...
    private void initComponents() {
        ...
        ActualizarButton.setActionCommand("ActualizarSocio");
