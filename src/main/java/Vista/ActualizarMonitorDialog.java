 ...
 * @author rubco
 */
public class ActualizarMonitorDialog extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ActualizarMonitorDialog.class.getName());
  
    /**
     * Creates new form InsertarMonitorDialog
     */
    public ActualizarMonitorDialog(java.awt.Frame parent, boolean modal, Monitor monitor) throws ParseException {
        super(parent, modal);
        initComponents();
        
        codigoTextField.setText(monitor.getCodMonitor());
        codigoTextField.setEnabled(false);
        
        nombreTextField.setText(monitor.getNombre());
        dniTextField.setText(monitor.getDni());
        
        telefonoTextField.setText(monitor.getTelefono());
        correoTextField.setText(monitor.getCorreo());
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        Date date = sdf.parse(monitor.getFechaEntrada());
        calendario.setDate(date);
        nickTextFIeld.setText(monitor.getNick());
    ...
    private void initComponents() {
        ...
        actualizarButton.setActionCommand("ActualizarMonitor");
